...
var comando = {
  ...
  3: "Custom Software Engineering Analyst - Accenture (Mayo 2022 - Actualidad)<br>Septiembre 2023 - Actualidad<br>Proyecto para el banco Galicia de Argentina en el cual desarrolló tareas de análisis, creación y mantenimiento de nuevos microservicios para la celula de Consumos y Pagos de la Tribu de Medios de Pago<br>- Tecnologías: Java 8, Spring/SpringBoot, BD Oracle PL/SQL, MongoDB, OpenShift, Jenkins, GIT.<br>- Testing: JUnit y Mockito.<br>- Calidad de código: SonarLint.<br>- Metodología: Scrum.<br><br>Mayo 2022 - Agosto 2023<br>Proyecto para el banco ICBC de Argentina en el cual desarrollé tareas de análisis, detección y corrección de errores, tanto de backend como de frontend para el canal ICBC Multipay Empresas.<br>- Tecnologías: Java 8, Spring Framework, Angular 2, BD Oracle PL/SQL, Jenkins, Kibana, GIT.<br>- Metodología: Kanban.<br><br>Software Developer - Certant (Agosto 2021 - Mayo 2022) <br> Proyecto para el banco Itau de Uruguay en el que desarrollé nuevos features y tareas de mantenimiento, tanto de backend como de frontend.<br>- Tecnologías: Java 7, Spring Framework, Maven, HTML, CSS (Bootstrap), Javscript (Jquery y Vanilla con Babel), MQ Queue, GIT.<br>- Testing: JUnit y Mockito.<br>- Calidad de código: SonarQube y SonarLint.<br> Metodología: Scrum",
